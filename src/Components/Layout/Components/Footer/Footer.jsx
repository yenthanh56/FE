		...
		<footer className={cx("footer")}>
			<div className={cx("footer__information")}>
				...
				<div className={cx("footer__information__partner")}>
					...
					<div className={cx("footer__information__partnerimage")}>
				...
				<div className={cx("footer__information__methodpay")}>
					...
					<p className={cx("footer__information__methodpay__icon")}>
						<span>
						...
						<span>
							<img src={LogoViettelPay} alt="logoViettelPay" />
						</span>
						<span>
							<img src={LogoVnPay} alt="logovnPay" width={30} />
						</span>
						<span>
			...
			<div className={cx("address-info")}>
				...
				<p>
					...
					trợ mua và nhận hàng trực tiếp tại văn phòng hoặc trung tâm
					xử lý đơn hàng
				</p>
				<p>
			...
			<div className={cx("tiki__about")}>
				...
				<p>
					...
					&nbsp;tới&nbsp;
					<a href="https://tiki.vn/di-cho-online">Rau củ quả tươi</a>,
					kèm theo dịch vụ giao hàng siêu tốc TikiNOW, Tiki mang đến
					cho bạn một trải nghiệm mua sắm online bắt đầu bằng chữ tín.
					Thêm vào đó, ở Tiki bạn có thể dễ dàng sử dụng vô vàn các
					tiện ích khác như&nbsp;
					<a href="https://tiki.vn/san-pham-so">
						mua thẻ cào, thanh toán hoá đơn điện nước, các dịch vụ
						bảo hiểm.
					</a>
				</p>
				...
				<p>
					...
					<a href="https://tiki.vn/deal-hot">giá sốc mỗi ngày</a> cho
					...
					&nbsp;đang chờ đón bạn. Không cần săn mã freeship, vì Tiki
					đã có hàng triệu sản phẩm trong&nbsp;
					...
					&nbsp;để nhận 100% free ship 2h & trong ngày, hoặc mua gói
					TikiNOW cao cấp để nhận được 100% freeship, áp dụng cho 100%
					sản phẩm, 100% tỉnh thành Việt Nam. Bạn muốn tiết kiệm hơn
					nữa? Đã có TikiCARD,
				...
				<div className={cx("tiki__grid")}>
					...
					<div className={cx("tiki__column")}>
						<div>
							<div>
								<a
									href="https://tiki.vn/do-choi-me-be/c2549"
									className={cx("toyMomvsBaby")}
								>
									Đồ Chơi - Mẹ & Bé
								</a>
							</div>
						...
						<div>
							<div>
								<a
									href="https://tiki.vn/do-choi-me-be/c2549"
									className={cx("appliancesElectric")}
								>
									Làm Đẹp - Sức Khỏe
								</a>
							</div>
					...
					<div className={cx("tiki__column")}>
						...
						<div>
							<div>
								<a
									href="https://tiki.vn/do-choi-me-be/c2549"
									className={cx("accessoryComputer")}
								>
						...
						<div>
							<div>
								<a
									href="https://tiki.vn/do-choi-me-be/c2549"
									className={cx("departmentStoreOnline")}
								>
									Bách hóa Online
								</a>
							</div>
							...
							>
								{departmentStoreOnline.map((item, index) => (
									<span key={index}>
										<Link to={item.path}>
											{item.display}
										</Link>
										<>
											{item.display === "Bộ quà tặng" ? (
												""
											) : (
												<>&nbsp;/&nbsp;</>
											)}
					...
					<div className={cx("tiki__column")}>
						<div>
							<div>
								<a
									href="https://tiki.vn/do-choi-me-be/c2549"
									className={cx("internationalGoods")}
								>
									Hàng quốc tế
								</a>
							</div>
						...
						<div>
							<div>
								<a
									href="https://tiki.vn/do-choi-me-be/c2549"
									className={cx("carMotorCycleBicycle")}
								>
									Ô tô - Xe máy - Xe đạp
								</a>
							</div>
					...
					<div className={cx("tiki__column")}>
						<div>
							<div>
								<a
									href="https://tiki.vn/do-choi-me-be/c2549"
									className={cx("electronicRefrigeration")}
								>
									Điện tử - Điện lanh
								</a>
							</div>
							...
							>
								{electronicRefrigeration.map((item, index) => (
									<span key={index}>
										<Link to={item.path}>
											{item.display}
										</Link>
										<>
											{item.display === "Tủ ướp rượu" ? (
												""
											) : (
												<>&nbsp;/&nbsp;</>
											)}
